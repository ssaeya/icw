...
public class CategoryJsonTypeHandler extends BaseTypeHandler<Object>{
...
//		if(d == null) return null;
//		
//		List<Category> cps = null;
//		ObjectMapper objectMapper = new ObjectMapper();
//		try {
//			cps = objectMapper.readValue(d.toString(), new TypeReference<List<Category>>() {});
//		} catch (JsonParseException e) {
//			e.printStackTrace();
//		} catch (JsonMappingException e) {
//			e.printStackTrace();
...
//		return cps;
	...
	public Category getNullableResult(ResultSet rs, int columnIndex) throws SQLException {
		...
		ObjectMapper objectMapper = new ObjectMapper();
		try {
			cp = objectMapper.readValue(d.toString(), Category.class);
		} catch (JsonParseException e) {
			e.printStackTrace();
		} catch (JsonMappingException e) {
			e.printStackTrace();
